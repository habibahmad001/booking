  ...
  <form method="POST" action="{{ URL::to( BASE_PATH . "instructor/events_add") }}" enctype="multipart/form-data" onSubmit="return validate('');">
    ...
    <div class="form-height-control">
      ...
      <div class="form-line timeitem">
        ...
        <select name="events_time_h" id="events_time_h" class="form-container col-md-4">
        ...
        <select name="events_time_m" id="events_time_m" class="form-container col-md-4">
        ...
        <select name="events_time_sec" id="events_time_sec" class="form-container col-md-4">
      ...
      <div class="form-line timeitem">
        ...
        <select name="events_time_eh" id="events_time_eh" class="form-container col-md-4">
          <option value="">Hours</option>
          <option value="00">00</option>
          <option value="01">01</option>
          <option value="02">02</option>
        ...
        <select name="events_time_em" id="events_time_em" class="form-container col-md-4">
          <option value="">Min</option>
          <option value="00">00</option>
          <option value="01">01</option>
          <option value="02">02</option>
        ...
        <select name="events_time_esec" id="events_time_esec" class="form-container col-md-4">
          <option value="">Sec</option>
          <option value="00">00</option>
          <option value="01">01</option>
          <option value="02">02</option>
