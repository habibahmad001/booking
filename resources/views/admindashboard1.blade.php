                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-5">
                                        ...
                                        <div class="d-flex align-items-center mr-2">
                                            ...
                                            <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                <div class="symbol-label">
                                                    <img src="{{URL::asset('euadmin/assets/media/svg/misc/006-plurk.svg')}}" class="h-50" alt="" />
                                                </div>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-5">
                                        ...
                                        <div class="d-flex align-items-center mr-2">
                                            ...
                                            <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                <div class="symbol-label">
                                                    <img src="{{URL::asset('euadmin/assets/media/svg/misc/015-telegram.svg')}}" class="h-50" alt="" />
                                                </div>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-flex align-items-center mr-2">
                                            ...
                                            <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                <div class="symbol-label">
                                                    <img src="{{URL::asset('euadmin/assets/media/svg/misc/003-puzzle.svg')}}" class="h-50" alt="" />
                                                </div>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                    ...
                                    <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_1">
                                            ...
                                            <td class="pr-0">
                                                <div class="symbol symbol-50 symbol-light mt-1">
																		<span class="symbol-label">
																			<img src="{{URL::asset('euadmin/assets/media/svg/avatars/001-boy.svg')}}" class="h-75 align-self-end" alt="" />
																		</span>
                                                </div>
                                            </td>
                                            <td class="pl-0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-0">
                                                <div class="symbol symbol-50 symbol-light mt-1">
																		<span class="symbol-label">
																			<img src="{{URL::asset('euadmin/assets/media/svg/avatars/018-girl-9.svg')}}" class="h-75 align-self-end" alt="" />
																		</span>
                                                </div>
                                            </td>
                                            <td class="pl-0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-0">
                                                <div class="symbol symbol-50 symbol-lightv mt-1">
																		<span class="symbol-label">
																			<img src="{{URL::asset('euadmin/assets/media/svg/avatars/047-girl-25.svg')}}" class="h-75 align-self-end" alt="" />
																		</span>
                                                </div>
                                            </td>
                                            <td class="pl-0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-0">
                                                <div class="symbol symbol-50 symbol-light mt-1">
																		<span class="symbol-label">
																			<img src="{{URL::asset('euadmin/assets/media/svg/avatars/014-girl-7.svg')}}" class="h-75 align-self-end" alt="" />
																		</span>
                                                </div>
                                            </td>
                                            <td class="pl-0">
