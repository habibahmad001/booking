...
class UserController extends Controller {
    ...
    public function index() {
        ...
        $data['users']        =  User::where('user_type','user')->orwhere('user_type', 'instructor')->orwhere('user_type', 'learner')->get();
    ...
    public function update(Request $request, $id = null) {
        ...
        /****** Update User Creator *********/
        $creat  =   User::findOrFail(Auth::user()->id);
        $creat->creator  =   "instructor";
        $creat->save();
        /****** Update User Creator *********/
        ...
        if($user->fill($input)->save()){
            $request->session()->flash('message', 'User was successful Edited!');
            return redirect('/'.collect(request()->segments())->first().'/my-account');
        } else {
            return redirect()->back()->with('error', 'Couldn\'t create organization!');
        }
